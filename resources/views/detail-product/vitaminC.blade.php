    ...
    <div class="px-[130px] py-12">
        <div class="grid grid-cols-2 mb-[100px]">
            <div class="col-span-1">
                <img src="../assets/images/vitamin c.svg" class="w-96 h-96" alt="">
            </div>
            <div class="col-span-1">
                <h1 class="text-[24px] font-poppins font-semibold mb-[53px]">Vitacimin Lemon Strip 2 Tablet</h1>
        ...
        <div class="">
            ...
            <h1 class="text-base text-black font-montserrat font-medium mb-12">VITACIMIN merupakan suplemen kesehatan
                dengan kandungan Ascorbic acid atau Vitamin C dalam bentuk tablet hisap. Suplemen ini digunakan untuk
                membantu memenuhi kebutuhan vitamin c harian, serta membantu menjaga daya tahan tubuh.</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Indikasi</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Pencegahan defisiensi vitamin C dan
                membantu menjaga daya tahan tubuh.</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Komposisi</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Vitamin C 500 mg</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Dosis</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Sehari 1-2 tablet, dihisap
                perlahan-lahan.</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Aturan Pakai</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Berikan setelah makan, untuk dihisap
                seperti permen</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Perhatian</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">-</h1>
            ...
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Vitamin & Suplemen</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Kemasan</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Dus, 50 Strip @ 2 Tablet hisap</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">Manufaktur</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">Takeda</h1>
            <h1 class="text-xl text-black font-montserrat font-semibold mb-4">No. Registrasi</h1>
            <h1 class="text-base text-black font-montserrat font-medium mb-12">BPOM: SD021501851/h1>
        </div>
