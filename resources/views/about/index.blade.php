...
<body>
    ...
    <div class="px-[130px] py-12">
        <h1 class="font-poppins text-[36px] text-black font-semibold ">
            Apotek Tugu Batu
        </h1>
        <div class="flex gap-20 items-center mt-12 mb-[100px]">
            <h1 class="font-poppins text-base text-black font-medium">Apotek Tugu Batu merupakan salah satu apotek di
                Kabupaten Banyumas tepatnya di Ruko Amira Town House No.10, Dusun II Prompong, Kutasari, Kec. Baturaden,
                Kabupaten Banyumas, Jawa Tengah yang didirikan oleh Bangkit Ari Sasongko pada tanggal 17 Agutus 2019.
                Apotek ini bersebelahan dengan Tugu Batu Prompong dan kantor kelurahan Kutasari. Apotek ini menjual
                berbagai produk kesehatan seperti obat-obatan, perlebngkapan ibu hamil dan anak, vitamin dan suplemen,
                produk perawatan tubuh, dan alat kesehatan. Jam operasional Apotek Tugu Batu adalah mulai pukul 07.00
                pagi hingga 22.00 malam.</h1>
            <img src="../assets/images/ilustrasi-about.svg" alt="">
        </div>
        ...
        <section class="bg-no-repeat bg-center bg-cover py-[66px] rounded-[25px] mt-[100px]"
            ...
            <div class="justify-center flex">
                <button
                    ...
                    untuk hubungi via whatsapp</button </div>
        </section>
    </div>
    <div class="">
